...
handlers.index = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        let templateData = {
            'head.title': 'Uptime Monitoring - Pure Node',
            'head.description': 'Free Nodejs uptime monitoring with no external dependencies! HTTP/HTTPS get alerted when your site goes down.',
            'body.class': 'index'
        };
...
handlers.accountCreate = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        let templateData = {
            ...
            'head.description': 'Signup is super easy',
            'body.class': 'accountCreate'
        };

        // Read in a template as string
        helpers.getTemplate('accountCreate', templateData, (err, accountCreateHTMLStr) => {
            if (!err && accountCreateHTMLStr) {
                // Add universal template
                helpers.addUniversalTemplate(accountCreateHTMLStr, templateData, (err, fullPageHTMLStr) => {
                    if (!err && fullPageHTMLStr) {
                        callback(200, fullPageHTMLStr, 'html');
                    } else {
                        callback(500, undefined, 'html');
...
handlers.sessionCreate = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        // Read in a template as string
        helpers.getTemplate('sessionCreate', templateData, (err, sessionCreateHTMLStr) => {
            if (!err && sessionCreateHTMLStr) {
                // Add universal template
                helpers.addUniversalTemplate(sessionCreateHTMLStr, templateData, (err, fullPageHTMLStr) => {
                    if (!err && fullPageHTMLStr) {
                        callback(200, fullPageHTMLStr, 'html');
                    } else {
                        callback(500, undefined, 'html');
...
handlers.sessionDeleted = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        // Read in a template as string
        helpers.getTemplate('sessionDeleted', templateData, (err, sessionDeletedHTMLStr) => {
            if (!err && sessionDeletedHTMLStr) {
                // Add universal template
                helpers.addUniversalTemplate(sessionDeletedHTMLStr, templateData, (err, fullPageHTMLStr) => {
                    if (!err && fullPageHTMLStr) {
                        callback(200, fullPageHTMLStr, 'html');
                    } else {
                        callback(500, undefined, 'html');
...
handlers.accountEdit = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        // Read in a template as string
        helpers.getTemplate('accountEdit', templateData, (err, accountEditHTMLStr) => {
            if (!err && accountEditHTMLStr) {
                // Add universal template
                helpers.addUniversalTemplate(accountEditHTMLStr, templateData, (err, fullPageHTMLStr) => {
                    if (!err && fullPageHTMLStr) {
                        callback(200, fullPageHTMLStr, 'html');
                    } else {
                        callback(500, undefined, 'html');
...
handlers.accountDeleted = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        // Read in a template as string
        helpers.getTemplate('accountDeleted', templateData, (err, accountDeletedHTMLStr) => {
            if (!err && accountDeletedHTMLStr) {
                // Add universal template
                helpers.addUniversalTemplate(accountDeletedHTMLStr, templateData, (err, fullPageHTMLStr) => {
                    if (!err && fullPageHTMLStr) {
                        callback(200, fullPageHTMLStr, 'html');
                    } else {
                        callback(500, undefined, 'html');
